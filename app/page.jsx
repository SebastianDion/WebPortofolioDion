      ...
      <div className="container mx-auto h-full">
        <div className="flex flex-col p-2 xl:flex-row items-center justify-between xl:pt-8 xl:pb-24">
          ...
          <div className="text-center xl:text-left order-2 xl:order-none">
            ...
            <h1 className="h1">
              Hello I'm <br />
              <span className="text-accent">Dion</span>
            </h1>
            <p className="max-w-[600px] mb-9 text-white/80 text-sm text-justify">
              Hello, I’m Seb. I build software and enjoy learning how
              things work. Software Engineer who loves games, collectibles, and
